...
import ParkingLotRegistrationForm from './components/ParkingRegistrationComponents/ParkingLotRegistrationForm';
import ParkingRegistrations from './components/AdminDashboardComponents/ParkingRegistrations';
            ...
            <ThemeProvider theme={theme}>
                ...
                <Container className={styles.root} maxWidth="1300px">
                    ...
                    <Routes>
                        ...
                        <Route exact path="/parking-registration" element={<ParkingLotRegistrationForm />} />
                        <Route exact path="/parking-registrations" element={<PrivateAdminRoute><ParkingRegistrations /></PrivateAdminRoute>} />
                    </Routes>
