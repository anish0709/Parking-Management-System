            ...
            <Grid container sx={styles.revCont} alignItems='center'>
              <Grid item xs={12} sm={6}>
                <Button
                  ...
                  to='/refunds'
                >
                  <Typography variant='h6'>Pay Refunds</Typography>
                </Button>
              </Grid>
              <Grid item xs={12} sm={6}>
                <img
            ...
            <Grid container sx={styles.revCont2} alignItems='center'>
              ...
              <Grid item xs={12} sm={6}>
                <Button
                  ...
                  variant='contained'
                  to='/parking-registrations'
                >
                  <Typography variant='h6'>Parking Registrations</Typography>
                </Button>
              </Grid>
            </Grid>
          </Grid>
