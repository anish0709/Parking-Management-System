...
const AddParkingLot = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const data = {
      ...
      mobileNo,
      type,
      openTime: openTime.format('HH').toString(),
      closeTime: closeTime.format('HH').toString(),
        ...
        <Grid container alignItems='center' justifyContent='center'>
          <Grid item xs={12} sm={12}>
            <Paper sx={{ ...styles.titlePaper, color: 'yellow' }}>
              <Typography variant='h3'>Add a New Parking Lot</Typography>
            </Paper>
          </Grid>
        </Grid>
        <form autoComplete='off' noValidate sx={styles.form} onSubmit={handleSubmit}>
          <Grid container sx={styles.formContainer} spacing={3} justifyContent='center'>
              ...
              <FormControl>
                ...
                >
                  <FormControlLabel
                    ...
                    label={<Typography fontSize={20}>Public</Typography>}
                  />
                  <FormControlLabel
                    value='private'
                    control={<Radio sx={{ '& .MuiSvgIcon-root': { fontSize: 28 } }} />}
                    label={<Typography fontSize={20}>Private</Typography>}
                  />
                </RadioGroup>
              </FormControl>
            </Grid>
            ...
            <Grid item xs={12} sm={12}>
              {imgFiles.length > 0 ? (
                <ImageList
                  sx={{ width: 500, height: 170, margin: 'auto' }}
                  cols={3}
                  rowHeight={160}
                >
                  {imgFiles.map((img, index) => (
                    <ImageListItem key={index}>
                      ...
                      <img src={img} srcSet={img} alt='Image title' loading='lazy' />
                    </ImageListItem>
                  ))}
                </ImageList>
              ) : null}
            ...
            <Grid item xs={12}>
              {inProgress1 ? (
                <Button
                  sx={{ width: '100%', padding: '1em', fontWeight: 'bold', fontSize: 14 }}
                  color='info'
                  variant='contained'
