...
const RegisterPage = () => {
  ...
  useEffect(() => {
    if (
      alert.msg === 'Vefiy OTP sent to your email To Access Your Account' ||
      alert.msg === 'Account Created, Verify OTP Sent to your email id to access your account'
    ) {
      setOtpSent(true);
      setResendOtp(false);
      setAlreadyOTP(true);
      ...
      alert.msg == 'You are already verified, you can login directly' ||
      alert.msg == "You're Registered Successfully, Login Now"
    ) {
      navigate('/login');
    }
  }, [alert]);
                    ...
                    <Grid container sx={styles.formContainer} spacing={2}>
                      ...
                      {!alreadyotp && !resendOtp ? (
                        <Grid item sm={12} xs={12} sx={styles.ipFields}>
                          ...
                          {imgFIleName !== '' ? (
                            <>
                              <Box border='1px solid black'>
                                <Typography>{imgFIleName}</Typography>
                              </Box>
                          ...
                          <FormHelperText
                            required
                            children='*Only jpg/jpeg/png file allowed to upload'
                          />
                        </Grid>
                      ) : null}
